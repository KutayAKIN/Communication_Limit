...
def Int_Feed_Action_norm_my10(n_device,n_class,D_target,P_cond,D_0,n_cache,A_ind,n_iter,x_dist,N_x):
    ...
    for _ in range(n_iter):
        for i in range(n_device):
            ...
            obtions = [x for x in random.sample(range(0,n_device-1),40)]
            obtions = 15*obtions
            indices = [j for j in np.concatenate([np.arange(obtions[0], obtions[0]+15), np.arange(obtions[1], obtions[1]+15), np.arange(obtions[2], obtions[2]+15) , np.arange(obtions[3], obtions[3]+15),
             ...
             np.arange(obtions[19], obtions[19]+15), np.arange(obtions[20], obtions[20]+15), np.arange(obtions[21], obtions[21]+15), np.arange(obtions[22], obtions[22]+15), np.arange(obtions[23], obtions[23]+15),
             np.arange(obtions[24], obtions[24]+15), np.arange(obtions[25], obtions[25]+15), np.arange(obtions[26], obtions[26]+15), np.arange(obtions[27], obtions[27]+15), np.arange(obtions[28], obtions[28]+15),
             np.arange(obtions[29], obtions[29]+15), np.arange(obtions[30], obtions[30]+15), np.arange(obtions[31], obtions[31]+15), np.arange(obtions[32], obtions[32]+15), np.arange(obtions[33], obtions[33]+15),
             np.arange(obtions[34], obtions[34]+15), np.arange(obtions[35], obtions[35]+15), np.arange(obtions[36], obtions[36]+15), np.arange(obtions[37], obtions[37]+15), np.arange(obtions[38], obtions[38]+15),
             np.arange(obtions[39], obtions[39]+15)])]
...
def Int_Feed_Action_norm_my20(n_device,n_class,D_target,P_cond,D_0,n_cache,A_ind,n_iter,x_dist,N_x):
...
def Int_Feed_Action_norm_my50(n_device,n_class,D_target,P_cond,D_0,n_cache,A_ind,n_iter,x_dist,N_x):
...
def Int_Ind_Action_norm(n_device,n_class,D_target,P_cond,D_0,n_cache,x_dist,N_x):
