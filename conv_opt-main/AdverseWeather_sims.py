...
def run_sim(opt,device):
    ...
    X_train,X_test,X_val,y_train,y_test,y_val,n_class = load_AdverseWeather_labels(opt.weather_loc,opt.daytime_loc,0.1,0.1,opt.cache_all)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--daytime-loc", type=str,default="./AdverseWeather/daytime_labels.yml")
    parser.add_argument("--weather-loc", type=str,default="./AdverseWeather/weather_labels.yml")
    parser.add_argument("--device-no", type=int,default=7)
    ...
    parser.add_argument("--run-loc", type=str, default="./runs/AdverseWeather")
