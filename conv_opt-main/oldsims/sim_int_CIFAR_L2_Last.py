...
train_dataset = create_CIFAR_traindataset(X_train,y_train,train_ind)

val_dataset = create_CIFAR_dataset(X_val,y_val,val_ind)

test_dataset = create_CIFAR_dataset(X_test,y_test,test_ind)
...
for n_cache in n_caches:
    for n_size in n_sizes:
        for n_device in n_devices:
            ...
            acc_df.to_csv("data/CIFAR_Acc.csv")
