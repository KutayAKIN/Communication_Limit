...
def run_sim(opt,device):
    ...
    X_train,X_test,X_val,y_train,y_test,y_val = load_CIFAR10_dataset(opt.dataset_loc,0.1)
    ...
    for sim_i in sim_bar:
        ...
        if 1:
            ...
            Unif_Model = CIFAR10_Unif_Sim(params,device)
            Ind_Model = CIFAR10_Ind_Sim(params,device)
            Feed_Model = CIFAR10_Feed_Sim(params,device)
            Coop_Model = CIFAR10_Coop_Sim(params,device)
            Lwb_Model = CIFAR10_Lwb_Sim(params,device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset-loc", type=str,default="./CIFAR10/data")
    ...
    parser.add_argument("--n-size", type=int, default=10000)
